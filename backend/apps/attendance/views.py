...
class TimetableViewSet(viewsets.ModelViewSet):
    ...
    def perform_destroy(self, instance):
        # Delete sessions generated by this timetable that haven't been marked yet
        # This prevents "orphan" sessions from cluttering the dashboard/subject views
        instance.generated_sessions.filter(status='NOT_ATTENDED').delete()
        instance.delete()
